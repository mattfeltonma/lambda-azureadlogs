...
def lambda_handler(event, context):
    ...
    try:
        ...
        for parameter in response['Parameters']:
            ...
            elif parameter['Name'] == "AzureGraphAPISignInEndpoint":
                endpoint = parameter['Value']
            elif parameter['Name'] == "AzureGraphAPIBucket":
                bucket = parameter['Value']
            elif parameter['Name'] == "AzureGraphAPISignInDays":
        ...
        filter = "createdDateTime gt " + yesterdaydate + " and createdDateTime lt " + todaydate
        ...
        s3_path = "aadsigninlogs/" + todaydate + "-" + yesterdaydate + ".json"
